...
// string
const firstName: string = "my name is dipjol";

// number
const rollNumber: number = 11;

// boolean
const isStudent: boolean = true;

// undefined
const dontKnow: undefined = undefined;

// null
const notAssigned: null = null;

// array
const friends: string[] = ["Raihan", "Mizan", "Rohan"];
...
let nameAge: [string, number] = ["Raihan", 23];
...
// যেমনঃ
let nameAgeStudent: [string, number, boolean] = ["Raihan", 23, true];
